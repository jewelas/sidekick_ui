  ...
  return (
    <Toolbar
      ...
      <h6 className="line-height-1 font-weight-bold">
        {getString(defiStrings.string31, selectedLangauge) + ' for $DRIP'}
      </h6>
...
export default function LatestDripTransactionsTable(props) {
  ...
  return (
    <>
      <Card className="bg-first px-2 pt-4 text-center" style={{ minHeight: '44vh' }}>
        <CSVLink
          data={tableData}
          filename="data.csv"
          className='hidden'
                    ...
                    {stableSort(displayRows, getComparator(order, orderBy))
                      ...
                      .map((row, index) => {
                        ...
                        if ((subscription.level < 1 && index > 4) || (page > 0 && subscription.level < 1)) {
                          row = rowScramble(row, 'dripRecentTrades');
                        }
                        ...
                        return (
                          <TableRow
                            ...
                            hover
                            onClick={subscription.level < 1 && index > 4 ? () => handleBlurredClick() : undefined}
                            tabIndex={-1}
                          ...
                          >
                            ...
                            <TableCell align="left" width="5%">{"$" + row.amountUsd.toLocaleString(undefined, { 'minimumFractionDigits': 2, 'maximumFractionDigits': 2 })}</TableCell>
                            <TableCell align="left" width="5%">{row.totalTokens.toLocaleString(undefined, { 'minimumFractionDigits': 3, 'maximumFractionDigits': 3 })}</TableCell>
                            {/*<TableCell align="right" style={{ display: 'none' }}>{row.walletType}</TableCell>*/}
                            <TableCell align="left" width="20%">{row.displayTime}</TableCell>
                            <TableCell align="center" width="5%" className="skSavedIcon">
