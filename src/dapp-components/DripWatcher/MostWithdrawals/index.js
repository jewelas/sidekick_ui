...
import { faSackDollar, faPiggyBank, faTint, faScythe, faRaindrops, faCauldron, faUser, faSearchDollar } from '@fortawesome/pro-duotone-svg-icons';
import { useStoreState } from 'easy-peasy';

export default function MostWithdrawals(props) {
